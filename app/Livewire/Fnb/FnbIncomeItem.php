...
#[Title('FNB | income Item ')]
class FnbIncomeItem extends Component
{
    ...
    {
        $this->item = FnbIncItem::findOrFail($id);
    ...
    {
        $this->items = FnbIncItem::all();
        return view('livewire.fnb.fnb-income-item')->layout('layouts.fnb');
    }
