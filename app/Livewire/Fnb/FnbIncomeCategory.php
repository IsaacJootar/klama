<?php
      ...
      namespace App\Livewire\Fnb;
        ...
        use Livewire\Attributes\Validate;
         ...
         #[Title('Food & Beverage | Make Income Category ')]
        class FnbIncomeCategory extends Component
        {
            ...
            {
                $this->category = FnbIncCategory::findOrFail($id);
            ...
            {
                $category = FnbIncCategory::findOrFail($id);
                $category->delete();
            ...
            {
                $this->categories = FnbIncCategory::all();
                return view('livewire.fnb.fnb-income-category')->layout('layouts.fnb');
            }
