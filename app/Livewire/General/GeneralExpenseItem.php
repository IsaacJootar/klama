...
#[Title('General Manager | General Expense Items ')]
class GeneralExpenseItem extends Component
{
    ...
    {
        $this->item = GeneralExpItem::findOrFail($id);
    ...
    {
        $item = GeneralExpItem::findOrFail($id);
        $item->delete();
    ...
    {
        $this->items = GeneralExpItem::all();
        return view('livewire.general.general-expense-item')->layout('layouts.general');
    }
