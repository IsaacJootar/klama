<?php
      ...
      namespace App\Livewire\Logistics;
        ...
        use Livewire\Attributes\Validate;
         ...
         #[Title('Logistics | Make Income Category ')]
        class LogisticsIncomeCategory extends Component
        {
            ...
            public function save()
            {
               ...
               $this->validate();// validate and then save
                ...
                LogisticsIncCategory::updateOrCreate(
                ['id' =>$this->category_id],
                    [
            ...
            {
                $this->category = LogisticsIncCategory::findOrFail($id);
            ...
            {
                $category = LogisticsIncCategory::findOrFail($id);
                $category->delete();
            ...
            {
                $this->categories = LogisticsIncCategory::all();
                return view('livewire.logistics.logistics-income-category')->layout('layouts.logistics');
            }
