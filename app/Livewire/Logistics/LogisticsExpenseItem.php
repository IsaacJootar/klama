...
#[Title('Logistics | Expense Items ')]
class LogisticsExpenseItem extends Component
{
    ...
    public function save()
    {
       ...
       $this->validate();// validate and then save
        ...
        LogisticsExpitem::updateOrCreate(
        ['id' =>$this->item_id],
            [
                'item'=>$this->item,
            ]
    ...
    {
        $this->item = LogisticsExpItem::findOrFail($id);
    ...
    {
        $item = LogisticsExpItem::findOrFail($id);
        $item->delete();
    ...
    {
        $this->items = LogisticsExpItem::all();
        return view('livewire.logistics.logistics-expense-item')->layout('layouts.logistics');
    }
