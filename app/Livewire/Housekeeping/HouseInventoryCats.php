...
use App\Models\HouseInventoryCat;
use Livewire\Attributes\Title;
use Livewire\Attributes\Validate;
use Flasher\Toastr\Prime\ToastrInterface;

#[title('Housekeeping  | Inventory Category')]

class HouseInventoryCats extends Component
{
    ...
    public function render()
    {
        ...
        $this->categories = HouseInventoryCat::all();
        return view('livewire.housekeeping.house-inventory-cats')->layout('layouts.housekeeping');
    }
     ...
     public function save()
     {
         ...
         HouseInventoryCat::updateOrCreate(
             ['id' => $this->category_id],
             [
                 'name' => $this->name,
             ]
     ...
     {
         $category  = HouseInventoryCat::findOrFail($id);
     ...
     {
         HouseInventoryCat::findOrFail($id)->delete();
