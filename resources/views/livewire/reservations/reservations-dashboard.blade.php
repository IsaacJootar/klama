        ...
        <div class="col-12">
            <div class="hero-card">
                <div class="hero-content">
                    <div class="hero-text">
                        <h4 class="hero-title" style="color: white; font-size: 32px;">Reservation Dashboard</h4>
                        ...
                        <div class="hero-stats">
                            ...
                            <span class="hero-stat">
                                ...
                                Total Revenue Today: {{ Helper::format_currency($revenue_today) }}
                            </span>
                            <span class="hero-stat">
                                <i class="fa-solid fa-wallet"></i>
                                Total Profit Today: {{ Helper::format_currency($profit_today) }}
                            </span>
                        </div>
                    </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card h-100 gradient-card-softgreen">
                <div class="card-body">
                    ...
                    <small class="d-block text-muted">Available: {{ $available_rooms }}</small>
                    <div class="progress mt-2" style="height: 6px; background: rgba(90, 75, 255, 0.16);">
                        <div class="progress-bar bg-white" style="width: {{ ($total_rooms > 0) ? ($available_rooms / $total_rooms * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card h-100 gradient-card-primary">
                <div class="card-body">
                    ...
                    <small class="d-block text-muted">Today: {{ $reservations_today }}</small>
                    <div class="progress mt-2" style="height: 6px; background: rgba(90, 75, 255, 0.16);">
                        <div class="progress-bar bg-white" style="width: {{ ($total_reservations > 0) ? ($reservations_today / $total_reservations * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            ...
                            <h3 class="mb-0">{{ $occupancy_rate }}%</h3>
                        </div>
                        <div class="avatar avatar-sm">
                    ...
                    <small class="d-block text-muted">From {{ $occupied_today }} rooms</small>
                    <div class="progress mt-2" style="height: 6px;">
                        <div class="progress-bar bg-teal" style="width: {{ $occupancy_rate }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            ...
                            <h3 class="mb-0">{{ $room_categories }}</h3>
                        </div>
                        <div class="avatar avatar-sm">
                    ...
                    <small class="d-block text-muted">Total: {{ $total_rooms }} rooms</small>
                    <div class="progress mt-2" style="height: 6px;">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            ...
                            <h3 class="mb-0">{{ $reservations_this_week }}</h3>
                        </div>
                        <div class="avatar avatar-sm">
                    ...
                    <small class="d-block text-muted">From {{ $reservations_today }} today</small>
                    <div class="progress mt-2" style="height: 6px; background: rgba(90, 75, 255, 0.16);">
                        <div class="progress-bar bg-white" style="width: {{ ($reservations_this_week > 0) ? ($reservations_today / $reservations_this_week * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            ...
                            <h3 class="mb-0">{{ $reservations_this_month }}</h3>
                        </div>
                        <div class="avatar avatar-sm">
                    ...
                    <small class="d-block text-muted">From {{ $reservations_today }} today</small>
                    <div class="progress mt-2" style="height: 6px; background: rgba(90, 75, 255, 0.16);">
                        <div class="progress-bar bg-white" style="width: {{ ($reservations_this_month > 0) ? ($reservations_today / $reservations_this_month * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card h-100 card-info">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <h5 class="card-title mb-1">Revenue Today</h5>
                            <h3 class="mb-0">{{ Helper::format_currency($revenue_today) }}</h3>
                        </div>
                        <div class="avatar avatar-sm">
                    ...
                    <small class="d-block text-muted">From {{ $reservations_today }} transactions</small>
                    <div class="progress mt-2" style="height: 6px;">
                        <div class="progress-bar bg-info" style="width: {{ ($revenue_today > 0) ? ($reservations_today / ($revenue_today + 1) * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card h-100 card-primary">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <h5 class="card-title mb-1">Profit Today</h5>
                            <h3 class="mb-0">{{ Helper::format_currency($profit_today) }}</h3>
                        </div>
                        <div class="avatar avatar-sm">
                            <span class="avatar-initial rounded-circle bg-primary-light text-primary">
                                <i class="fa-solid fa-wallet"></i>
                    ...
                    <small class="d-block text-muted">Expenses: {{ Helper::format_currency($expenses_today) }}</small>
                    <div class="progress mt-2" style="height: 6px;">
                        <div class="progress-bar bg-primary" style="width: {{ ($profit_today > 0) ? ($expenses_today / ($profit_today + $expenses_today + 1) * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            ...
                            <h3 class="mb-0">{{ Helper::format_currency($revenue_this_week) }}</h3>
                        </div>
                        <div class="avatar avatar-sm">
                    ...
                    <small class="d-block text-muted">From {{ $reservations_this_week }} transactions</small>
                    <div class="progress mt-2" style="height: 6px; background: rgba(90, 75, 255, 0.16);">
                        <div class="progress-bar bg-white" style="width: {{ ($revenue_this_week > 0) ? ($reservations_this_week / ($revenue_this_week + 1) * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            ...
                            <h3 class="mb-0">{{ Helper::format_currency($revenue_this_month) }}</h3>
                        </div>
                        <div class="avatar avatar-sm">
                    ...
                    <small class="d-block text-muted">From {{ $reservations_this_month }} transactions</small>
                    <div class="progress mt-2" style="height: 6px;">
                        <div class="progress-bar bg-danger" style="width: {{ ($reservations_this_month > 0) ? ($reservations_this_month / ($reservations_this_month + 1) * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            ...
                            <h3 class="mb-0">{{ Helper::format_currency($profit_this_week) }}</h3>
                        </div>
                        <div class="avatar avatar-sm">
                    ...
                    <small class="d-block text-muted">Expenses: {{ Helper::format_currency($expenses_this_week) }}</small>
                    <div class="progress mt-2" style="height: 6px;">
                        <div class="progress-bar bg-warning" style="width: {{ ($profit_this_week > 0) ? ($expenses_this_week / ($profit_this_week + $expenses_this_week + 1) * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            ...
                            <h3 class="mb-0">{{ Helper::format_currency($profit_this_month) }}</h3>
                        </div>
                        <div class="avatar avatar-sm">
                            <span class="avatar-initial rounded-circle bg-teal-light text-teal">
                                <i class="fa-solid fa-wallet"></i>
                    ...
                    <small class="d-block text-muted">Expenses: {{ Helper::format_currency($expenses_this_month) }}</small>
                    <div class="progress mt-2" style="height: 6px;">
                        <div class="progress-bar bg-teal" style="width: {{ ($profit_this_month > 0) ? ($expenses_this_month / ($profit_this_month + $expenses_this_month + 1) * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Weekly Reservations</h5>
                    <div class="dropdown">
