...
<div class="table-responsive text-nowrap">
 ...
 <tr>
                            ...
                            <th>Total revenue generated from sales</th>
                            <th>Amount of food/beverage wasted</th>
                             <th>Number of customer complaints</th>
                             <th>Number of special meal requests</th>
                              <th>Number of ingredients/items used</th>
                             <th>Remaining stock count</th>
        ...
        <div class="nav-align-top">
          ...
          <div class="tab-content border-0  mx-1">
            <div class="tab-pane fade show active" id="navs-justified-new" role="tabpanel">
                        ...
                        <div class="card-body">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="avatar me-4">
                                        <span class="avatar-initial rounded bg-label-primary">
                                             <i class='ti ti-list-check ti-28px'></i> <!-- Total Orders -->
                                             </span>
                                    </div>
                                    <h4 class="mb-0">{{\App\Models\Report::where('report_id', $report_id)->get()->value('total_orders')}}</h4>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="avatar me-4">
                                        ...
                                        <i class='ti ti-currency-dollar ti-28px'></i> <!-- Total Revenue -->
                                        
                                        </span>
                                    </div>
                                    <h4 class="mb-0">{{\App\Models\Report::where('report_id', $report_id)->get()->value('total_revenue')}}</h4>
                                </div>
                                <p class="mb-1">revenue generated</p>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="avatar me-4">
                                <span class="avatar-initial rounded bg-label-primary">
                                <i class='ti ti-trash ti-28px'></i> <!-- Wastage -->
                            </span>
                                    </div>
                                    <h4 class="mb-0">{{\App\Models\Report::where('report_id', $report_id)->get()->value('wastage')}}</h4>
                                </div>
                                <p class="mb-1">wasted</p>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <i class='ti ti-message-circle-exclamation ti-28px'></i> <!-- Complaints -->
                                 </span>
                                    </div>

                                    <h4 class="mb-0">{{\App\Models\Report::where('report_id', $report_id)->get()->value('complaints_received')}}</h4>
                                </div>
                                <p class="mb-1">customer complaints</p>
                            </div>
                ...
                <i class='ti ti-package ti-28px'></i> <!-- Ingredients/Items Used -->
            </span>
                                    </div>

                                    <h4 class="mb-0">{{\App\Models\Report::where('report_id', $report_id)->get()->value('special_requests')}}</h4>
                                </div>
                                <p class="mb-1">special meal requests</p>
                            </div>
                ...
                <i class='ti ti-archive ti-28px'></i> <!-- Remaining Stock -->
            </span>
                                    </div>

                                    <h4 class="mb-0">{{\App\Models\Report::where('report_id', $report_id)->get()->value('inventory_used')}}</h4>
                                </div>
                                <p class="mb-1">ingredients/items used</p>
                            </div>
                ...
                <i class='ti ti-cash ti-28px'></i> <!-- Total Money Spent -->
            </span>
                                    </div>

                                    <h4 class="mb-0">{{\App\Models\Report::where('report_id', $report_id)->get()->value('inventory_remaining')}}</h4>
                                </div>
                                <p class="mb-1">Remaining stock count</p>
                            </div>
                ...
                <i class='ti ti-cash ti-28px'></i> <!-- Total Money Spent -->
                                    ...
                                    <h4 class="mb-0">{{\App\Models\Report::where('report_id', $report_id)->get()->value('amount')}}</h4>
                                </div>
                                <p class="mb-1">money spend</p>
                            </div>
