...
<div>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div>
            <x-modal-home-create-button data-bs-target="#makeincome">Make income </x-modal-home-create-button>
        </div>
        <hr class="my-2">
        <div class="card">
                ...
                <table id="myTable" class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr wire:key='{{$income->id}}'>
                            ...
                            <td>
                                {{(\App\Models\FnbExpItem::where('id', $income->item_id)->get()->value('item'))}}
