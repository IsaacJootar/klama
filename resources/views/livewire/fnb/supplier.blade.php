<div>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div>
        <x-home-page-label>Create, update, and delete Supplier Here</x-home-page-label>
      </div>

      <div>
        <x-modal-home-create-button data-bs-target="#addOrder">Create Supplier</x-modal-home-create-button>
      </div>
      <hr class="my-2">
      <div class="card">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item" href="javascript:void(0)"
                        wire:confirm="Are you sure you want to proceed and delete this Supplier?"
          ...
          <div class="modal-content">
            <div class="modal-body">
              ...
              <div class="col-12">
                ...
                <label class="form-label w-100" for="modaladdFleet">Supplier Name </label>
                ...
                <label class="form-label w-100" for="modalAddValue">Supplier Address</label>
                <div class="input-group input-group-merge">
                  <textarea wire:model="address" placeholder="Supplier Address"
                ...
                <label class="form-label w-100" for="modaladdFleet">Supplier Phone Number </label>
                <div class="input-group input-group-merge">
                ...
                <label class="form-label w-100" for="modaladdFleet">Supplier Email </label>
                <div class="input-group input-group-merge">
