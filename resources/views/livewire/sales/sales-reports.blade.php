<div>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <!-- Page Label -->
        <div>
            <x-home-page-label>Send and Update Your Daily, Weekly or Monthly Sales Report Here</x-home-page-label>
        </div>
                ...
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr wire:key='{{$report->id}}'>
                            ...
                            <td>${{ number_format($report->revenue_generated, 2) }}</td>
                            <td>{{$report->new_clients}}</td>
                            <td>{{$report->deals_closed}}</td>
                            <td>
                                <div class="dropdown">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <h4 class="mb-2"><x-home-page-label>Send Sales Report</x-home-page-label></h4>
                    </div>
                            ...
                            <div class="step" data-target="#inputs">
                                <button type="button" class="step-trigger">
                                    ...
                                    <span class="bs-stepper-label">
                                        ...
                                        <span class="bs-stepper-subtitle">Enter Sales Summary</span>
                                    </span>
                                </button>
                            </div>
                            <div class="line"></div>
                        ...
                        <div class="bs-stepper-content p-1">
                            <form onSubmit="return false">
                                ...
                                <div id="inputs" class="content pt-4 pt-lg-0">
                                    <h6>Enter Sales Data</h6>
                                    <label class="form-label w-100">Total Sales</label>
                                    <input wire:model='total_sales' class="form-control form-control-lg" type="text" placeholder="E.g. 50" />

                                    <label class="form-label w-100">Revenue Generated</label>
                                    <input wire:model='revenue_generated' class="form-control form-control-lg" type="text" placeholder="E.g. 25000.75" />

                                    <label class="form-label w-100">New Clients Acquired</label>
                                    <input wire:model='new_clients' class="form-control form-control-lg" type="text" placeholder="E.g. 10" />

                                    <label class="form-label w-100">Follow-ups</label>
                                    <input wire:model='follow_ups' class="form-control form-control-lg" type="text" placeholder="E.g. 15" />

                                    <label class="form-label w-100">Deals Closed</label>
                                    <input wire:model='deals_closed' class="form-control form-control-lg" type="text" placeholder="E.g. 5" />

                                    <label class="form-label w-100">Refunds Processed</label>
                                    <input wire:model='refunds_processed' class="form-control form-control-lg" type="text" placeholder="E.g. 2" />
                                ...
                                <div id="submit" class="content text-center pt-4 pt-lg-0">
                                    ...
                                    <select wire:model="sent_to" class="form-select form-select-lg">
                                        ...
                                        <option value="1234">Sales Manager</option>
                                    </select><br>
