<html lang="en" class=" layout-navbar-fixed layout-wide " dir="ltr" data-skin="default" data-assets-path="assets/" data-template="front-pages" data-bs-theme="light">
  <head>
    ...
    <title>VINE INT'L SUITES</title>


      <meta name="description" content="http://vinehousegroup.com/" />
      <!-- Canonical SEO -->
      <meta name="keywords" content="http://vinehousegroup.com/" />
      <meta property="og:title" content="http://vinehousegroup.com/" />
      <meta property="og:type" content="product" />
      <meta property="og:url" content="http://vinehousegroup.com/" />
      <meta property="og:image" content="http://vinehousegroup.com/" />
      <meta property="og:description" content="http://vinehousegroup.com/." />
      <meta property="og:site_name" content="http://vinehousegroup.com/" />
      <link rel="canonical" href="http://vinehousegroup.com/" />
  ...
  <div class="container">
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <div class="navbar-brand app-brand demo d-flex py-0 me-4 me-xl-8 ms-0">
        ...
        <a href="https://vinehousegroup.com/" class="app-brand-link">
      ...
      <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto">
          <li class="nav-item">
            <a class="nav-link fw-medium" aria-current="page" href="https://vinehousegroup.com">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-medium" href="https://vinehousegroup.com/about-us/">About Us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-medium" href="https://vinehousegroup.com/gallery/">Gallery</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-medium" href="https://vinehousegroup.com/contact-us/">Contact us</a>
          </li>
        </ul>
      </div>
...
<div class="tab-content" id="scrollspyHeading2">
    <div class="tab-pane fade show active" id="list-home" role="tabpanel">
        <div class="d-flex justify-content-center align-items-center text-center min-vh-100">
            <div class="custom-width text-start"> <!-- Slightly smaller than 80% -->
                {{ $slot }}
            </div>
        </div>
    </div>
...
<footer class="landing-footer bg-body footer-text">
  <div class="footer-top position-relative overflow-hidden z-1">
    <img src="{{ asset('assets/img/front-pages/backgrounds/footer-bg-light.png') }}" alt="footer bg" class="footer-bg banner-bg-img z-n1" />
    <div class="container">
      <div class="row gx-0 gy-6 g-lg-10">
        <!--<div class="col-lg-5">-->
        <!--  <a href="landing-page.html" class="app-brand-link mb-6">-->
        <!--    <span class="app-brand-text demo footer-link fw-bold ms-2 ps-1">Vine International </span>-->
        <!--  </a>-->
        <!--  <p class="footer-text footer-logo-description mb-6">Vine International Suites and Resorts is part of collection of finest independent luxury hotels in our region.</p>-->
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
          ...
          <!--  <li class="mb-4">-->
          <!--    <a href="https://vinehousegroup.com/" class="footer-link">Home</a>-->
          <!--  </li>-->
          <!--  <li class="mb-4">-->
          <!--    <a href="https://vinehousegroup.com/about-us/" class="footer-link">About Us<span class="badge bg-primary ms-2">New</span></a>-->
          <!--  </li>-->
          <!--  <li class="mb-4">-->
          <!--    <a href="https://vinehousegroup.com/contact-us/" class="footer-link">Contact us</a>-->
          <!--  </li>-->
          <!--  <li class="mb-4">-->
          <!--    <a href="../vertical-menu-template/auth-login-cover.html" target="_blank" class="footer-link">Staff Login</a>-->
          <!--  </li>-->
          <!--</ul>-->
        </div>
  ...
  <div class="footer-bottom py-3 py-md-5">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      <div class="mb-2 mb-md-0">
        ...
        <a href="https://klickitsystems.com/" target="_blank" class="fw-medium text-white">Klickit Systems</a>
        <span class="footer-bottom-text"> Made with ❤️ from Nigeria </span>
      </div>
      <div>
